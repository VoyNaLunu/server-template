...
return [
    ...
    'model_invalid_fix'         => 'Актив должен быть отредактирован для исправления этого перед попыткой его вернуть или выдать.',
    'requestable'               => 'Можно запросить',
...
<p>
    ...
    'custom_export' => 'Настраиваемый экспорт',
