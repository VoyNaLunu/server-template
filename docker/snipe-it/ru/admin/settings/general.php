...
return [
    ...
    'admin_cc_email_help'       => 'Если вы хотите отправлять копии писем, что приходят пользователям при возврате/выдаче, на какой-то дополнительный адрес электронной почты, то введите его здесь. В противном случае оставьте это поле пустым.',
    'is_ad'				        => 'У вас сервер Active Directory',
    'alerts'                	=> 'Уведомления',
    'alert_title'               => 'Редактировать настройки оповещений',
    'alert_email'				=> 'Посылать уведомления на',
    'alert_email_help'    => 'Адреса электронной почты или списки рассылок, на которые вы хотите отправлять оповещения, разделённые запятыми',
    ...
    'allow_user_skin'           => 'Разрешить пользовтельские темы оформления',
    'allow_user_skin_help_text' => 'Включение этого флажка позволит пользователю заменить оформление пользовательского интерфейса другим оформлением.',
    'asset_ids'					=> 'ID актива',
    ...
    'auto_increment_assets'		=> 'Генерировать автоматически увеличивающиеся инвентарные номера',
    'auto_increment_prefix'		=> 'Префикс (не обязательно)',
    'auto_incrementing_help'    => 'Сначала включите автоматическое увеличение инвентарного номера, чтобы установить это',
    ...
    'backups_path'              => 'Резервные копии на сервере хранятся в <code>:path</code>',
    'backups_restore_warning'   => 'Используйте кнопку восстановления <small><span class="btn btn-xs btn-warning"><i class="text-white fas fa-retweet" aria-hidden="true"></i></span></small> для восстановления из предыдущей резервной копии. (В настоящее время это не работает с хранилищем файлов S3 или Docker.<br><br> <strong>вся ваша база данных :app_name и все загруженные файлы будут полностью заменены</strong> на то, что находится в файле резервной копии.  ',
    'backups_logged_out'         => 'Всем существующим пользователям, включая вас, нужно будет заново войти после завершения восстановления.',
    'backups_large'             => 'С очень большими резервными копиями может истечь время ожидания попытки восстановления, и может потребоваться выполнение через командную строку. ',
    'barcode_settings'			=> 'Настройки штрихкода',
    'confirm_purge'			    => 'Подтвердить очистку',
    ...
    'display_asset_name'        => 'Отображаемое название актива',
    'display_checkout_date'     => 'Отображать дату выдачи',
    'display_eol'               => 'Отображать дату истечения срока службы в таблице',
    ...
    'general_settings_keywords' => 'поддержка компании, подпись, принятие, формат электронной почты, формат имени пользователя, изображения, на каждую страницу, превью, пользовательское соглашение, основная панель, конфиденциальность',
    'general_settings_help'     => 'Пользовательское соглашение по умолчанию и ещё',
    ...
    'ldap_default_group_info'   => 'Выберите группу для назначения новых синхронизированных пользователей. Помните, что пользователь получает права группы, в которую он назначен.',
    'no_default_group'          => 'Нет группы по умолчанию',
    'ldap_help'                 => 'LDAP/Active Directory',
    'ldap_client_tls_key'       => 'LDAP Client-Side TLS key',
    'ldap_client_tls_cert'      => 'Клиентский TLS сертификат LDAP',
    ...
    'ldap_dept'                 => 'LDAP Департамент',
    'ldap_phone'                => 'LDAP Номер телефона',
    'ldap_jobtitle'             => 'LDAP Должность',
    'ldap_country'              => 'LDAP Страна',
    ...
    'ldap_test'                 => 'Проверить LDAP',
    'ldap_test_sync'            => 'Проверить синхронизацию LDAP',
    ...
    'login_user_agent'          => 'Клиентское приложение',
    ...
    'login_remote_user_header_name_text' => 'Настраиваемый заголовок имени пользователя',
    ...
    'full_multiple_companies_support_help_text' => 'Ограничить доступ пользователям (включая админов) только к активам их компаний.',
    ...
    'php_overview_help'         => 'Информация о системе PHP',
    ...
    'pwd_secure_complexity_disallow_same_pwd_as_user_fields' => 'Пароль не может быть таким же, как имя, фамилия, адрес электронной почты или имя пользователя',
    'pwd_secure_complexity_letters' => 'Требовать как минимум одну букву',
    'pwd_secure_complexity_numbers' => 'Требовать как минимум одно число',
    'pwd_secure_complexity_symbols' => 'Требовать как минимум один символ',
    'pwd_secure_complexity_case_diff' => 'Требовать как минимум одну заглавную и одну строчную буквы',
    ...
    'saml'                      => 'SAML',
    'saml_title'                => 'Редактировать настройки SAML',
    ...
    'slack'                     => 'Slack',
    'general_webhook'           => 'Основной вебхук',
    'webhook'                   => ':app',
    'webhook_presave'           => 'Тест сохранения',
    'webhook_title'               => 'Редактировать настройки вебхуков',
    'webhook_help'                => 'Integration settings',
    'webhook_botname'             => 'Имя бота :app',
    'webhook_channel'             => ':app Channel',
    'webhook_endpoint'            => ':app Endpoint',
    'webhook_integration'         => ':app Settings',
    'webhook_test'                 =>'Тестировать интеграцию :app',
    ...
    'value'                     => 'Значение',
    'brand'                     => 'Брендинг',
    'brand_keywords'            => 'нижний колонтитул, логотип, печать, тема, оформление, заголовок, цвета, цвет, css',
    'brand_help'                => 'Логотип, название сайта',
    ...
    'purge_deleted'             => 'Очистить удалённые ',
    ...
    'require_accept_signature_help_text'      => 'Включение этой функции потребует от пользователей физически расписываться при принятии актива.',
    'left'        => 'слева',
    'right'        => 'справа',
    'top'        => 'сверху',
    'bottom'        => 'снизу',
    ...
    'asset_tag_title' => 'Редактировать настройки инвентарного номера',
    'barcode_title' => 'Редактировать настройки штрих-кода',
    'barcodes' => 'Штрих-коды',
    'barcodes_help_overview' => 'Настройки штрих-кода &amp; QR',
    'barcodes_help' => 'This will attempt to delete cached barcodes. This would typically only be used if your barcode settings have changed, or if your Snipe-IT URL has changed. Barcodes will be re-generated when accessed next.',
    'barcodes_spinner' => 'Попытка удаления файлов...',
    'barcode_delete_cache' => 'Удалить штрих-код кэш',
    'branding_title' => 'Редактировать настройки брендинга',
    'general_title' => 'Редактировать основные настройки',
    'mail_test' => 'Отправить тестовое электронное письмо',
    'mail_test_help' => 'Это попытается отправить тестовое сообщение на :replyto.',
    'filter_by_keyword' => 'Фильтровать по ключевому слову',
    'security' => 'Безопасность',
    'security_title' => 'Редактировать настройки безопасности',
    'security_keywords' => 'пароль, пароли, требования, двухфакторный, двухфакторный, часто используемые пароли, удалённый вход, выход из системы, аутентификация',
    ...
    'localization_title' => 'Редактировать настройки локализации',
    'localization_keywords' => 'localization, currency, local, locale, time zone, timezone, international, internatinalization, language, languages, translation',
    'localization_help' => 'Язык, отображение даты',
    'notifications' => 'Уведомления',
    'notifications_help' => 'Email alerts, audit settings',
    'asset_tags_help' => 'Увеличение и префиксы',
    'labels' => 'Метки',
    'labels_title' => 'Редактировать настройки меток',
    'labels_help' => 'Размеры меток &amp; настройки',
    'purge' => 'Очистить',
    'purge_keywords' => 'удалить безвозвратно',
    ...
    'create_admin_success' => 'Успешно! Ваш суперпользователь был добавлен!',
    'create_admin_redirect' => 'Нажмите здесь, чтобы перейти на страницу авторизации!',
    'setup_migrations' => 'Миграции базы данных ::',
    'setup_no_migrations' => 'Нет ничего для миграции. Ваши таблицы базы данных уже настроены!',
